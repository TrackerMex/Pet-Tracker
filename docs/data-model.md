...
| `weights` | id PK, pet_id FK, weight_kg numeric(5,2), body_condition CHECK (1..9), measured_at date, created_by FK | Implementada por `health-weights` (#15, migración `0010`); actualiza `pets.current_weight_kg` si es la más reciente |
