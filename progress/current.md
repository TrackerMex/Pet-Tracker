...
- Avance: R1, R2 y R3 completos. M1 y M3 probadas, documentadas y restauradas; `format.test.ts` quedó 13/13 verde. Commits y evidencia en `traceability.md` / `impl_mobile-home-reminders-real-data.md`. Siguiente paso: M4.
