...
- **Bloqueo detectado por Codex (2026-09-06)**: R18 es un requisito de verificación que, en el orden aprobado, nace verde tras R1-R11; la spec no declara la vía C4(b) ni contiene excepción humana. Implementación no iniciada. Evidencia y enmienda necesaria en `progress/impl_mobile-ui-language.md`.
