...
- **#67 NO pasa a `done`**, pese al veredicto aprobado. Faltan **dos gates que solo cierra el humano**: (a) marcar las nueve casillas de firma A1-A9 en los cinco ficheros enmendados, y (b) el smoke en **dev build de Android**, con foto y sin foto, en tema claro y oscuro, con la lista de comprobacion de `requirements.md` §Aprobacion.
- **Dos apuntes para el ojo del humano en el smoke** (O3 del reviewer): el titulo "Inicio" **desaparece** de Home cuando hay mascota -R5 obliga a que el hero sea el primer hijo del scroll, y el implementer eligio quitarlo en vez de meterlo bajo la foto; se sigue pintando en las tres ramas sin mascota, es decision declarada y no descuido-; y hay que mirar que el degradado no deje banda gris en la transicion a la banda opaca y que la foto no recorte la cara del animal por arriba.
