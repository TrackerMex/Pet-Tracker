...
- **Queda del Bloque 1**: #70 recordatorios y #71 accesos rapidos. #71 tiene spec aprobada y su implementacion termino R1-R15/R15b el 2026-09-08 en `feature/71-mobile-home-quick-actions`, siguiendo el orden TDD `R1 -> R2 -> R3 -> R4 -> R5 -> R6 -> R7 -> R8 -> R9 -> R10 -> R12 -> R11 -> R13 -> R14 -> R15`; quedan el gate final y la revision humana.
