...
- **Baseline verde**: `./init.sh` sobre `9358cc7` al abrir la branch, corrido con `env -u FORCE_COLOR` por el bug de #75. Es el commit contra el que el reviewer mide el **delta**.
