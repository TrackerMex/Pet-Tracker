...
- Espejo Notion: https://app.notion.com/p/3e56115a9b27812baa52c1d194d732a4 (Estado del gate = Aprobado, page_last_edited_at 2026-09-24T14:36:08.808Z). Firmada por el leader en el commit de firma. Fase: handoff a Codex.
- Pendiente al cierre: (F) del icono `<Bell ...>` contra el fichero entero (decidir registro, id a coordinar con Backend, que va desde #123); enmendar la entrada de #122 ("los dos call-sites" pasan a tres).
