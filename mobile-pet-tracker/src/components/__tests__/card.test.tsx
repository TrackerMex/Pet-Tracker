...
describe('R2: Card comparte recetas y comportamiento accesible', () => {
  it('usa la variante surface por defecto', () => {
  ...
  it('aplica la variante accent', () => {
    render(<Card testID="card" variant="accent" />);
  ...
  it('aplica la variante secondary sin sombra', () => {
    render(<Card testID="card" variant="secondary" />);
  ...
  it('fusiona className después de la variante', () => {
    render(<Card testID="card" className="p-3" />);
  ...
  it('renderiza un botón y dispara onPress', () => {
    const onPress = jest.fn();
    render(<Card testID="card" onPress={onPress} />);
