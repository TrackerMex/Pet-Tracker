...
| R5 | `src/app/(tabs)/__tests__/health.test.tsx::R5 (mobile-design-drift): aplica el safe area superior al contenido`; `src/screens/weight-log/index.test.tsx::R5 (mobile-design-drift, enmendado por #95 R6): el inset superior lo consume la cabecera nativa` | `3af19b8 fix(mobile-design-drift): apply top safe areas (R5)`; mitad weight-log enmendada por #95 R6 |
