...
| R8 | `consistency-classnames.test.ts` **#62 R14** (`:269-332`): fila `screens/home/index.tsx` **1 → 2** y total cerrado `33 + 1` → `33 + 1 + 1`; y **#62 R4** (`:149-155`) en verde con lista vacía | `f8040c3` `feat(mobile-home-quick-actions): test tile radius and corner (R8)` (rojo; verde pendiente) |
