...
| R10 | `GRID`::`it('coloca la rejilla entre el collar y la actividad semanal')`, que espera `['summary-card','collar-card','quick-actions','weekly-activity-card','last-position-card']` tras filtrar los hijos de `home-content` + `GRID`::`it('no dibuja la rejilla sin mascota seleccionada')` + los dos candados de orden heredados, `HOME:1181-1209` (#68) y `HOME:1364-1414` (#69), **en verde y sin tocar** | `2f9ec85` `feat(mobile-home-quick-actions): test grid placement (R10)` (rojo; verde pendiente) |
