...
|---|---|---|
| R1 | `GRID`::`it('dibuja el rótulo y los tres tiles en orden')`: los tres `testID` presentes y en el orden del árbol, `quick-actions-title` con `Accesos rápidos` y la receta canónica de rótulo de sección, y ningún cuarto tile | pendiente |
