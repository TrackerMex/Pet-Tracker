...
| R6 | `src/app/(tabs)/__tests__/map.test.tsx::#94 R6: el tile de conexión se rotula como en Pairing` | rojo `8986802d` (`feat(mobile-map-staleness): specify connection tile label (R6)`); verde pendiente |
