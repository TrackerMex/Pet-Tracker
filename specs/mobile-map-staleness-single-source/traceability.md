...
| R5 | `src/__tests__/design-drift.test.ts::#94 R5: el umbral de frescura no vive en el móvil` | rojos `cb6084e7` (`feat(mobile-map-staleness): guard mobile freshness threshold (R5)`) + `d6f28bec` (`feat(mobile-map-staleness): probe shared utility threshold (R5)`); verde pendiente |
