...
| R4 | `src/app/(tabs)/__tests__/map.test.tsx::#94 R4: la antigüedad y la conexión son datos independientes` | rojo `feeabb27` (`feat(mobile-map-staleness): lock position age source (R4)`); verde pendiente |
