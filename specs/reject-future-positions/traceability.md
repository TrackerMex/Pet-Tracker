...
| R4 | `src/workers/positions-consumer.service.spec.ts::R4 (reject-future-positions #27): el consumidor pasa now a normalize() y no persiste la posición futura` | rojo: `6182328 feat(reject-future-positions): add consumer clock test (R4)`; verde: `577c7f4 feat(reject-future-positions): filter future positions in consumer (R4)` |
| R5 | `src/workers/positions-consumer.service.spec.ts::R5 (reject-future-positions #27): los descartes se loguean agrupados por razón` (2 `it`) | rojo: `a90f796 feat(reject-future-positions): add discarded position warning tests (R5)`; verde: `7cddf71 feat(reject-future-positions): log discarded position counts (R5)` |
