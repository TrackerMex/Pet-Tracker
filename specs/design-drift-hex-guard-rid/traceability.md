...
|---|---|---|---|---|
| R1 — el átomo hex y la lista de sombra se declaran una sola vez | `src/__tests__/design-drift.test.ts` :: `#108 R1: los patrones compartidos se declaran una sola vez` | 2 | `74c7cd29` | pendiente |
