...
| R2 — el guard ignora `#<id> R<n>` y sigue disparando ante cualquier hex | `src/__tests__/design-drift.test.ts` :: `#108 R2: el guard de estilo distingue un R-id de un color hex` | 8 | `63908134` | pendiente |
