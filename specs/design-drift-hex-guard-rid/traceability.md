...
| R4 — la convención `#<id> R<n>` queda escrita en `docs/conventions.md` | `src/__tests__/design-drift.test.ts` :: `#108 R4: la convención de cita del guard está documentada` | 1 | `75b4d0d3` | pendiente |
