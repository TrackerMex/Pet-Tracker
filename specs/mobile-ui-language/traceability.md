...
| R18 | cero copy suelta (325 sitios) | `mobile-pet-tracker/src/__tests__/ui-language.test.ts::#65 R18: los sitios resuelven por clave y no queda copy suelta` | rojo: `f82d975`; verde: `24fa49a feat(mobile-ui-language): resolve the last 5 copy sites by key (R18)`. Escáner sin regiones ciegas tras el rechazo del reviewer — rojo: `2895e9d`; verde: `2f6a2b5 fix(mobile-ui-language): scan copy from the AST, not a regex lexer (R18)` |
