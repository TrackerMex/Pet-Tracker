...
| R13 | checkbox humano marcado en requirements.md (smoke Expo Go 2026-08-21 con backend real: mascota por API, claim ACT-001, posiciones del simulador; fixes post-smoke safe-area y flash verificados) | `3ee6815` Record Human Smoke Test Completion |
