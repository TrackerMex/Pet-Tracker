...
| R4 | `src/screens/pairing/index.test.tsx::R4: /pairing monta en el Stack raíz con selector de mascota y estados de carga` | `9148d10 test(mobile-device-pairing): cover pairing route loading states (R4)` → `c6fd268 feat(mobile-device-pairing): add pairing route shell (R4)`; enmendado por #95 R2 |
