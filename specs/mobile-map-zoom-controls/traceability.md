...
| R3 | sin test — smoke humano en dev build de Android: controles `+` / `−` ausentes **y** pinch-to-zoom acercando y alejando, registrado en `progress/impl_mobile-map-zoom-controls.md::Resultado del smoke R3` y con la casilla marcada en [[requirements]] §Aprobación | smoke humano aprobado el 2026-09-01 en `aa1da88 Mark Android map zoom smoke test complete` |
