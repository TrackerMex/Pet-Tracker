...
| R6 | **verificación humana, sin test** — fade verificado por el humano en Android; decisión **mantener** registrada en [[requirements]] §Decisión del gate humano (2026-08-26, con observación: la animación no luce como el prototipo de la librería) | `434e104` (commit del humano, cierra el gate) |
