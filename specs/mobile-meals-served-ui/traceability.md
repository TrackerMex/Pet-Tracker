...
| R8 — cardinalidad, orden y cero llamadas nuevas | `src/screens/home/index.test.tsx` :: `#98 R8: la barra de comidas entra sin traerse el cliente de nutrición` (reemplaza a `#70 R3`, `:3459-3475`) | `f2bd2cbd` | pendiente |
