...
|---|---|---|---|
| R1 — tipos `servedToday` / `mealsToday` + 10 fixtures | `src/screens/home/index.test.tsx` :: `#98 R1: los tipos del cliente declaran servedToday y mealsToday` | pendiente | pendiente |
