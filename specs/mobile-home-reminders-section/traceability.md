...
|---|---|---|
| R1 | `SEC`::`describe('#70 R1: estructura de la sección')`::`it('dibuja la cabecera y el cuerpo de la sección')` (dos hijos directos de `reminders-section`, rótulo con su receta, enlace presente). Por la decisión humana D1, la cardinalidad vive en R9, cuando existen sus tres hijos reales | pendiente |
