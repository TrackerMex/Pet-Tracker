...
| R4 | `backend-pet-tracker/src/aws/aws-endpoint-guard.spec.ts::R4: modo local intacto` + `backend-pet-tracker/src/aws/aws-mode.spec.ts` (adaptado, [[design]] §D10) | `backend-pet-tracker/src/aws/aws-clients.ts`, `backend-pet-tracker/src/aws/aws-mode.spec.ts` | regresión verde inicial: `c9027d2 test(aws-mode-endpoint-guard): preserve already-green local behavior (R4)`; adaptación: `9fb6a3c test(aws-mode-endpoint-guard): adapt #19 mode fixtures to the endpoint guard (R4)`; refactor: `d18cfd2 style(aws-mode-endpoint-guard): apply lint formatting (R4,R7)` |
...
| R6 | `backend-pet-tracker/test/aws-real-ingest.e2e-spec.ts::R6: aborta si AWS_ENDPOINT_URL sigue definida` | `backend-pet-tracker/test/aws-real-ingest.e2e-spec.ts` | guardas: `1b0be58 feat(aws-mode-endpoint-guard): reject unexpected env endpoint (R1)` y `4eb9dca feat(aws-mode-endpoint-guard): guard ConfigService endpoint resolution (R5)`; canario rojo seguro: `852a403 test(aws-mode-endpoint-guard): expose contaminated real-ingest runs (R6)` |
| R7 | `backend-pet-tracker/src/aws/aws-endpoint-guard-docs.spec.ts::R7: verification.md documenta la guarda` | `docs/verification.md` | rojo: `4857274 test(aws-mode-endpoint-guard): require verification guard docs (R7)`; verde: `4b4142f docs(aws-mode-endpoint-guard): document automatic endpoint guard (R7)`; refactor: `d18cfd2 style(aws-mode-endpoint-guard): apply lint formatting (R4,R7)` |
| R9 | Sin test — evidencia: `git log --oneline` de `feature/21-aws-mode-endpoint-guard`, esta tabla completa y `progress/impl_aws-mode-endpoint-guard.md` con `./init.sh` exit 0 | `progress/impl_aws-mode-endpoint-guard.md` | inicio: `8d56770 docs(aws-mode-endpoint-guard): start implementation log (R9)`; cierre: `8708b88 docs(aws-mode-endpoint-guard): record final verification (R9)` |
