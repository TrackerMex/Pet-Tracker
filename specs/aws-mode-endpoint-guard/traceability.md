...
| R4 | `backend-pet-tracker/src/aws/aws-endpoint-guard.spec.ts::R4: modo local intacto` | `backend-pet-tracker/src/aws/aws-clients.ts` | regresión verde inicial: `c9027d2 test(aws-mode-endpoint-guard): preserve already-green local behavior (R4)`; sin cambio productivo, según `tasks.md` R4(2) |
