...
| R7 | `backend-pet-tracker/src/aws/aws-endpoint-guard-docs.spec.ts::R7: verification.md documenta la guarda` | `docs/verification.md` | rojo: `4857274 test(aws-mode-endpoint-guard): require verification guard docs (R7)`; verde: `4b4142f docs(aws-mode-endpoint-guard): document automatic endpoint guard (R7)` |
