...
| R15b | Las **seis** mutaciones de [[tasks]] §R15 (2), plantadas de una en una, con la evidencia en `progress/impl_mobile-home-stats-strip.md` §prueba de mutación. Las **cuatro primeras** son un mismo discriminante en cuatro sitios: el criterio de aceptación es que las cuatro pongan la suite roja **por separado** | `1586d07` prueba roja versionada → `6c170da` restauración verde; las seis mutaciones fallaron por separado en R3 ×4, R2 y R6, según `progress/impl_mobile-home-stats-strip.md` |
