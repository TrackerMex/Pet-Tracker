...
| R4 | `test/devices.e2e-spec.ts::R4 (claim-activation-code-only #26): findByIdentifier sigue buscando por los 4 campos` | prueba este commit (`test(claim-activation-code-only): preserve internal identifier lookup (R4)`); tipo preservado en `7456f83` (R5) |
