...
- [x] (2) Implementación mínima que lo pasa — crear
...
- [x] (1) Escribir test que falla para R2 — dos ficheros:
...
- [x] (2) Implementación mínima que lo pasa — los **tres** cambios de
      ...
      y `cacheKey={pet.id}`.
- [x] (3) Refactor con tests verdes — comprobar que los tres llamantes
...
- [x] (2) Implementación mínima que lo pasa — `bg-background` en
...
- [x] (2) Implementación mínima que lo pasa — `Skeleton` de heroui, nunca un
...
- [x] (2) Implementación mínima que lo pasa — borrar el pet-card inline
      ...
      `home-empty`.
- [x] (3) Refactor con tests verdes — confirmar que `collar-*`, `summary-*`,
...
- [x] (2) Implementación mínima que lo pasa — borrar la función local `PetHero`
...
- [x] (3) Refactor con tests verdes — comprobar que
...
- [x] (2) Implementación mínima que lo pasa — añadir `'home.walks'` a `en`
...
- [x] (3) Refactor con tests verdes — actualizar `R3_HOME` en
...
- [x] (1) Prueba de mutación, **antes** de tocar los candados y con la
...
- [x] (2) Actualizar los candados con los **deltas** de [[requirements]] R9b,
...
- [x] (3) `./init.sh` verde de punta a punta y suite móvil completa verde sin
...
- [x] (2) Implementación mínima que lo pasa — insertar el bloque en los seis
      ficheros de la tabla ([[design]] §8, bloque "Modificados —
      documentación"), **con la casilla sin marcar**.
- [x] (3) Refactor con tests verdes. **PARA aquí**: la casilla la marca el
...
- [x] `traceability.md` sin ninguna fila "pendiente" (C5).
- [x] `progress/impl_mobile-pet-hero-header.md` escrito mientras se trabaja, no
      al final.
- [x] `./init.sh` verde.
