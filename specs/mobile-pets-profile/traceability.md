...
| R10 | Regresión estructural: `src/app/(tabs)/__tests__/layout.test.tsx::R10: las rutas de mascotas heredan SelectedPetProvider`; `src/screens/add-pet/index.test.tsx::R6: alta de mascota`; `src/screens/profile/index.test.tsx::R10: refetch al foco`; `src/app/(tabs)/__tests__/home.test.tsx::R10: refetch al foco`; `src/app/(tabs)/__tests__/home.test.tsx::R10: preserva la mascota durante el refetch`; `src/app/(tabs)/__tests__/health.test.tsx::R10: preserva la mascota durante el refetch`; `src/app/(tabs)/__tests__/food.test.tsx::R10: preserva la mascota durante el refetch`; `src/hooks/use-pet-selection.test.tsx::R10: usePetSelection respeta el foco y la revalidación`; `src/hooks/use-pet-selection.test.tsx::R10: la selección automática vive solo en usePetSelection`; smoke humano pendiente de repetirse | `644a00c` rojo → `5bae7b0` verde (rutas, hallazgo del smoke 2026-08-25); `a8cbd7e` rojo → `c3ce9b9` verde (lista stale al volver de AddPet, hallazgo del smoke 2026-08-25); `d3c00cd` rojo → `9bf01bc` verde (`router.back()` y selección preservada durante revalidación, hallazgo del smoke 2026-08-25); `6ef7c26` rojo → `76f7990` verde (guard de selección en Home, Health y Food durante revalidación, hallazgo del smoke 2026-08-25); `48bcf80` rojo → `1541d7c` verde (hook compartido con guard de foco, hallazgo smoke fix6 del 2026-08-25); `f07d720` rojo → `ac3d090` verde (guardia estructural y migración de Map/Reminders, hallazgo review fix7 del 2026-08-25); gate humano pendiente |
