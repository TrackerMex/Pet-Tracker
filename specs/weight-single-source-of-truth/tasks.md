...
- [x] (1) Escribir tests que fallan para R1 — editar
...
- [x] (2) Implementación mínima que lo pasa — quitar `weightKg` de
...
- [x] (1) Escribir tests que fallan para R2 — editar
...
- [x] (2) Implementación mínima que lo pasa — simplificar
...
- [x] (1) Escribir test que falla para R4 — mismo archivo que R3, caso 1
      (assertions sobre `current_weight_kg`/`updated_at` sin cambios,
      incluidas en el mismo `it` o en uno separado)
- [x] (2) Implementación mínima que lo pasa — ya cubierta por R3 si
...
- [x] (1) N/A — requisito documental, no de código; no requiere test rojo
- [x] (2) Editar `docs/data-model.md` filas `pets` y `weights` según
      [[requirements]] R5
- [x] (3) N/A

## R6 — GET /v1/pets/:petId sin cambios de contrato (regresión)

- [x] (1) N/A — requisito de no-regresión; se verifica corriendo la
      suite existente sin tocarla
- [x] (2) N/A — no hay código que escribir para este requisito
- [x] (3) Confirmar que `pet-profile-response.mapper.spec.ts`,
