...
- ~~UI en inglés (decisión de #38 vigente)~~ **UI en catálogo de dos
  idiomas desde #65, español por defecto (ver §Enmienda #65)**; los
  literales de esta spec pasan a ser la columna `en` de su clave; el
  diseño está en español, los literales de esta spec son los normativos.
...
- **Qué NO cambia**: **el literal inglés de esta spec sigue siendo normativo**
  ...
  trazabilidad `R-id ↔ test` de `mobile-reminders` sigue siendo válida.
