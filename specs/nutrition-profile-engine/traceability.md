...
| R27 | `test/nutrition.e2e-spec.ts::R27 (nutrition-profile-engine #17): numeric llega al cliente como number` | test ancla (verde por R16): `5ac4065 test(nutrition-profile-engine): cover numeric response boundary (R27)`; implementacion: `45e9f24 feat(nutrition-profile-engine): add profile replacement endpoint (R16)` |
