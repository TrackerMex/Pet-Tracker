...
| R4 | `init-e2e-gate.test.mjs::R4 (harness-e2e-nunca-corre-en-ci #96): la infra caida aborta init.sh con codigo 1` | rojo: `cc5f2936` `test(ci-e2e): require hard infra failure (R4)`; verde: pendiente |
