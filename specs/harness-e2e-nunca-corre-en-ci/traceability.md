...
| R3 | `init-e2e-gate.test.mjs::R3 (harness-e2e-nunca-corre-en-ci #96): los puertos se derivan del .env` | rojo: `4a13f00a` `test(ci-e2e): derive probe targets from env (R3)`; verde: pendiente |
