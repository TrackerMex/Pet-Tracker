...
| R6 | `init-e2e-gate.test.mjs::R6 (harness-e2e-nunca-corre-en-ci #96): migraciones y provisioning antes de los e2e` | rojo: `9fa459fe` `test(ci-e2e): require setup before e2e (R6)`; verde: pendiente |
