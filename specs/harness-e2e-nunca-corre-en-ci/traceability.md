...
| R9 | `init-e2e-gate.test.mjs::R9 (harness-e2e-nunca-corre-en-ci #96): docs/verification.md documenta el gate` | rojo: `f6d82df7` `test(ci-e2e): require gate runbook (R9)`; verde: pendiente |
