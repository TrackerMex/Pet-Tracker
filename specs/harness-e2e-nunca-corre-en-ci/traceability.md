...
| R7 | `init-e2e-gate.test.mjs::R7 (harness-e2e-nunca-corre-en-ci #96): la suite entra en TEST_CMD y en el mapa del repo` | rojo: `8d8eacfb` `test(ci-e2e): require harness gate wiring (R7)`; verde: pendiente |
