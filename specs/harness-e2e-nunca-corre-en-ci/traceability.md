...
| R2 | `init-e2e-gate.test.mjs::R2 (harness-e2e-nunca-corre-en-ci #96): el workflow fija AWS_MODE local y nunca toca AWS real` | rojo: `ba934c99` `test(ci-e2e): forbid real AWS in CI (R2)`; verde: pendiente |
