...
|---|---|---|---|---|
| R1 — `expo-haptics` declarada, sin `babel.config.js`, carta enmendada | #106 | `src/app/(tabs)/__tests__/food.test.tsx` :: `#106 R1: expo-haptics entra declarada y sin configuración de babel` | pendiente | pendiente |
