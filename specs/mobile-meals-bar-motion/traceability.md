...
| R2 — el relleno `reminders-meals-fill` transiciona su ancho con `withTiming` | #106 | `src/screens/home/index.test.tsx` :: `#106 R2: la barra de comidas transiciona su ancho` | `a616ce07`; refuerzo B1: `7308a788` (rojo de un primer intento de test, no un rojo producido por producción); cierre B6: sonda de mutación, sin commit rojo (ver impl §Cierre de B6) | `03c68786`; refuerzo B1: `2004d56d`; cierre B6: `726cd302` |
| R3 — con reduce motion el ancho se fija sin animar | #106 | `src/screens/home/index.test.tsx` :: `#106 R3: reduce motion deja la barra sin animación` | `592a5046` | `3626b779` |
