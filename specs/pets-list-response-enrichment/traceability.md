...
| R2 | `backend-pet-tracker/src/modules/pets/infrastructure/pets.controller.spec.ts::R2 (pets-list-response-enrichment #66): GET /v1/pets serializa el photoUrl de cada item sin alterar el contrato` | `backend-pet-tracker/src/modules/pets/infrastructure/pets.controller.ts` | `558b75c test(pets-list-response-enrichment): GET /v1/pets serializa photoUrl con contrato intacto (R2)` → `e93149f feat(pets-list-response-enrichment): GET /v1/pets serializa photoUrl del listado (R2,R3)` |
| R3 | `backend-pet-tracker/test/pets.e2e-spec.ts::R3 (pets-list-response-enrichment #66): GET /v1/pets devuelve photoUrl prefirmada para la mascota con photo_key` | `backend-pet-tracker/src/modules/pets/infrastructure/pets.controller.ts` (+ use case de R1) | `9c387b2 test(pets-list-response-enrichment): e2e GET /v1/pets firma photoUrl con la misma clave que el detalle (R3)` → `bbed5e8 style(pets-list-response-enrichment): format R3 e2e setup (R3)` → `e93149f feat(pets-list-response-enrichment): GET /v1/pets serializa photoUrl del listado (R2,R3)` |
