...
| R1b | mismo `describe` que R1 → `it('pinea 7.0.4 porque la geometría del eje depende de sus constantes')` | rojo `287bdf3` `feat(mobile-home-weekly-activity): test pinned chart geometry contract (R1b)`; verde por completar |
