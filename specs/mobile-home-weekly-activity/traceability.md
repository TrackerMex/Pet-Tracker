...
| R16 | `src/utils/device-connectivity.test.ts`::`R16: la conectividad se traduce por catálogo` (3 `it`: conocido, desconocido, `null`) + el `it` actualizado de `src/screens/pairing/index.test.tsx:511`, con los de `:531,:543` intactos | rojo `aad245f` `feat(mobile-home-weekly-activity): test connectivity catalog mapping (R16)`; verde por completar |
