...
| R6 | `CHART`::`R6: el selector cambia de métrica sin volver a pedir nada` + `HOME`::`it('no vuelve a pedir la actividad al cambiar de métrica')` | rojo `a398211` `feat(mobile-home-weekly-activity): test weekly metric selector (R6)`; verde por completar |
