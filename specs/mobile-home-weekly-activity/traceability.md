...
| R13 | `CHART`::`R13: la semana entera sin dato se resuelve con un mensaje` (3 `it`) | rojo `22ba924` `feat(mobile-home-weekly-activity): test empty weekly activity state (R13)`; verde por completar |
