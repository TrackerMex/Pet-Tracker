...
| R8 | `CHART`::`R8: tocar un día abre su detalle` (tooltip, panel, día `missing`, `onSelectDay`) + `HOME`::`it('ofrece el mapa solo para el día de hoy')` | rojo `b6c98d1` `feat(mobile-home-weekly-activity): test daily activity detail (R8)`; verde `796b5b6` `feat(mobile-home-weekly-activity): add daily activity detail (R8)` |
