...
| R19 | Los deltas y las reubicaciones de la tabla de [[requirements]] R19, verificados por el reviewer **rehaciendo cada grep**, no leyendo el informe del implementer. Ojo a la distinción: (a) ruta que cambia con la cifra intacta, (b) delta real | rojo `05dc74f` `feat(mobile-home-weekly-activity): test harness deltas (R19)`; verde por completar |
