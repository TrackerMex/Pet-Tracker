...
| R9 | `CHART`::`R9: cada columna se anuncia por separado` (7 etiquetas en los dos idiomas, contenedor sin etiqueta, `accessibilityLabel` traducido en el gráfico y ausencia de `getBarChartAccessibilitySummary`) | rojo `8f7c50a` `feat(mobile-home-weekly-activity): test per-day chart accessibility (R9)`; verde por completar |
