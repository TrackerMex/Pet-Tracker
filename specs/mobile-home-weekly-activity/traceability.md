...
| R18 | `src/__tests__/design-drift.test.ts`::`#68 R18: la actividad semanal no mete drift de estilo`, sobre la lista nominal de ficheros de esta feature | rojo `2620934` `feat(mobile-home-weekly-activity): test feature style drift (R18)`; verde por completar |
