...
| R10 | `CHART`::`R10: las barras entran animadas y respetan reduced motion` (2 `it`, con `useReducedMotion` mockeado como en `src/theme/__tests__/theme-transition.test.tsx`) | rojo `709e71f` `feat(mobile-home-weekly-activity): test chart entry animation (R10)`; verde por completar |
