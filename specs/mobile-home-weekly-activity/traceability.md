...
| R2 | `CHART`::`R2: WeeklyActivityChart recibe los días y no habla con la red` | rojo `9ea68fb` `feat(mobile-home-weekly-activity): test weekly chart component boundary (R2)`; verde por completar |
