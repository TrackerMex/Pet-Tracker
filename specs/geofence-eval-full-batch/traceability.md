...
| R2 | `src/pipeline/geofence-eval-untouched.spec.ts::R2 (geofence-eval-full-batch #30): geofence-eval.ts queda congelado en el estado de #30` (2 `it`) | rojo: `bad02af` (R1 rompe ambos hashes); verde: pendiente |
