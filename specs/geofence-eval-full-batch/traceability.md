...
| R7 | `src/workers/alerts-engine/alerts-engine-consumer.service.spec.ts::R7 (geofence-eval-full-batch #30): evalúa el lote entero en orden ascendente de ts` (3 `it`: a, b, c) | rojo: `312804c feat(geofence-eval-full-batch): add full batch evaluation tests (R7)`; verde: pendiente |
