...
| R11 | `src/workers/alerts-engine/alerts-engine-consumer.service.spec.ts::R11 (geofence-eval-full-batch #30): un solo updateGeofenceState por geocerca y mensaje` | rojo: `9e1e2e9 feat(geofence-eval-full-batch): add single state write test (R11)`; verde: pendiente |
