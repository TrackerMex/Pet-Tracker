...
| R2 | AC1 (**redactado obsoleto**, ver §Criterios obsoletos) — cubre su intención: la etiqueta sobre el acento pasa AA en los dos temas | `src/theme/__tests__/global-css.test.ts::#61 R2: el relleno de acento pasa AA con etiqueta blanca` | **1** (token) | PENDING_R2 |
