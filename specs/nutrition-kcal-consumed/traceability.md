...
| R4 | `backend-pet-tracker/test/meals.e2e-spec.ts::R4 (nutrition-kcal-consumed #104): tras cambiar el plan kcalConsumedToday se recalcula con el plan vigente` | `bf6217af` `test(nutrition-kcal-consumed): kcal con el plan vigente tras regenerar (R4)`; feat pendiente (verificación vía (a)) |
