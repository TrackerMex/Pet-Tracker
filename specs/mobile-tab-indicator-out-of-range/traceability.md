...
| R8 | Guion en `progress/impl_mobile-tab-indicator-out-of-range.md` §R8; **PASS** humano en dev build de Android, 2026-09-14 | guion `c3cf74a1`; probado sobre `b5faca09` |
