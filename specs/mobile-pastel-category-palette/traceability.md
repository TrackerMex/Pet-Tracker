...
| R9 | `src/__tests__/consistency-classnames.test.ts::#64 R9: el color categórico solo se nombra en el módulo de paleta` | `3e42193` — `feat(mobile-pastel-palette): R9 verifica el inventario categórico` (rojo `f41678b`; encapsulado en su `describe` por `0c3346d`) |
| R10 | `src/__tests__/consistency-classnames.test.ts::#64 R10: la carta declara la paleta categórica y su tabla de huecos` | `349e349` — `feat(mobile-pastel-palette): R10 documenta la tabla de huecos` (rojo `2af79d5`) |
