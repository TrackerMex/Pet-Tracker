...
| R2 | requisito de verificación (C4 vía (b)): candados (b) de [[requirements]] §Inventario intactos + inventario de producción a 0 + `git diff --stat` acotado, en `progress/impl_drop-devices-connectivity-column.md` §R2 | sin test ni implementación propios; evidencia en el impl §R2 sobre `0a131779` |
