...
| R9 | `mobile-pet-tracker/src/screens/home/index.test.tsx :: #73 R9: la pildora del hero y collar-status nacen del mismo estado` | rojo `b0570334` (`test(pet-online-pill): require shared hero connectivity state (R9)`); verde `5793f723` (`feat(pet-online-pill): share hero connectivity state (R9)`) |
| R10 | requisito de verificación (C4 vía (b)): candados existentes de [[requirements]] §Candados + 5 sondas de mutación en `progress/impl_pet-online-pill.md` §R10 | sin hash de test; evidencia de sondas y verificación final en `progress/impl_pet-online-pill.md` §R10 |
