...
| R9 | `mobile-pet-tracker/src/screens/home/index.test.tsx :: #73 R9: la pildora del hero y collar-status nacen del mismo estado` | rojo `b0570334` (`test(pet-online-pill): require shared hero connectivity state (R9)`); verde pendiente |
