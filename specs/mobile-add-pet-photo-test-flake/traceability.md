...
| R3 | `mobile-pet-tracker/src/screens/profile/index.test.tsx` :: `#72 R3: el mock del picker no hereda implementación entre tests` | `7d49df5e` `test(add-pet-photo-test-flake): profile inherits the picker mock between tests (R3)` (rojo) + pendiente (verde) |
