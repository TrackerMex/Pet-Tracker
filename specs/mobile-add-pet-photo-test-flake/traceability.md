...
| R4 | `mobile-pet-tracker/src/screens/add-pet/index.test.tsx` :: `#72 R4: el fallo del picker nombra el invariante roto` | `ff33b7e7` `test(add-pet-photo-test-flake): the picker failure must name the broken invariant (R4)` (rojo) + pendiente (verde) |
