...
|---|---|---|---|
| R1 | pendiente — previsto `backend-pet-tracker/src/aws/resource-names.spec.ts::R1: los diez nombres con sufijo test` | `backend-pet-tracker/src/aws/resource-names.ts` | pendiente |
| R2 | pendiente — previsto `backend-pet-tracker/src/aws/resource-names.spec.ts::R2: el sufijo se deriva de NODE_ENV` | `backend-pet-tracker/src/aws/resource-names.ts`, `backend-pet-tracker/src/aws/aws-clients.ts` | pendiente |
