...
- **`mobile-reminders-see-all-source-lock-nesting` (#112) done** (2026-09-24,
  ...
  Sin prueba de humo, firmado en la spec. PR pendiente del merge humano.
